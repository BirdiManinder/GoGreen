...
export const home = {
  title: { firstWord: "Let`s", lastWord: "together" },
...
export const blog = {
  ...
  recentPost: {
    title: "Recent posts",
    posts: [
      { title: "Natural With Forest  ", date: "July,20,2022" },
      { title: "Natural With World", date: "July,15,2022" },
      { title: "The Refinning World`s", date: "July,6,2022" },
    ],
  },
  tags: {
    title: "Tags",
